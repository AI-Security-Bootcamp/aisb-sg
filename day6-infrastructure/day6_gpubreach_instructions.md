...
<details>
<summary><b>Question 4.2:</b> Why is the IOMMU, which we all rely on for DMA isolation, not the right tool here?</summary><blockquote>
...
<details>
<summary><b>Question 4.3:</b> How would a real attacker find the target PTE row from an unprivileged process?</summary><blockquote>
